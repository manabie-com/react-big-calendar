...
var MonthView = /*#__PURE__*/ (function (_React$Component) {
  ...
  function MonthView() {
    ...
    _this.widthRef = /*#__PURE__*/ _react.default.createRef() // my custom
      ...
      value: function componentDidMount() {
        ...
        window.addEventListener(
          ...
          (this._resizeListener = function () {
            ...
            if (!_this2.props.collapse) {
              currentWidth = _this2.widthRef.current.offsetWidth
            } else {
