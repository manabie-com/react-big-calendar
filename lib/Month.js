  ...
  (function(_React$Component) {
    ...
    function MonthView() {
      ...
      _this2.renderWeek = function(week, weekIdx) {
        var _this2$props = _this2.props,
          ...
          utilities = _this2$props.utilities
      ...
      _this2.readerDateHeading = function(_ref) {
        ...
        var _this2$props2 = _this2.props,
          ...
          utilities = _this2$props2.utilities
      ...
      _this2.renderDateFooter = function(_ref2) {
        ...
        var _this2$props3 = _this2.props,
          ...
          utilities = _this2$props3.utilities
        var isOffRange = dates.month(date) !== dates.month(currentDate)
        var isCurrent = dates.eq(date, currentDate, 'day')
    ...
    _proto.render = function render() {
      var _this$props = this.props,
        ...
        month = dailyStatuses
          ? dates.visibleDays(date, localizer).map(function(monthDate) {
...
MonthView.propTypes =
  process.env.NODE_ENV !== 'production'
    ? {
        utilities: _propTypes.default.object,
