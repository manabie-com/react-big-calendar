    ...
    function MonthView() {
      ...
      _this.renderWeek = function(week, weekIdx) {
        ...
        return _react.default.createElement(_DateContentRow.default, {
          ...
          renderFooter: _this.renderDateFooter,
      ...
      _this.renderDateFooter = function(_ref2) {
        var date = _ref2.date,
        ...
        var _this$props3 = _this.props,
          currentDate = _this$props3.date,
          localizer = _this$props3.localizer
        var isOffRange = dates.month(date) !== dates.month(currentDate)
        var isCurrent = dates.eq(date, currentDate, 'day')
        var DateFooterComponent =
          _this.props.components.dateFooter || _DateFooter.default
        var label = localizer.format(date, 'dateFormat')
        return _react.default.createElement(
          'div',
          (0, _extends2.default)({}, props, {
