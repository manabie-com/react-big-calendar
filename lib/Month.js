  ...
  (function(_React$Component) {
    ...
    _proto.render = function render() {
      ...
      if (dailyStatuses.length != month.length) {
        console.warn(
          'react-big-calendar: dailyStatuses length is not matching the visible days on calendar. \n        Make sure ' +
            dailyStatuses +
            ' and ' +
            month +
            ' matches so that the data is correctly displayed\n      '
        )
      }
