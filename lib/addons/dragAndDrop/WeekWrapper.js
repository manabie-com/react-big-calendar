    ...
    function WeekWrapper() {
      ...
      _this._selectable = function() {
        ...
        selector.on('beforeSelect', function(point) {
          ...
          var eventNode = (0, _Selection.getEventNodeFromPoint)(node, point) // eventOffsetLeft is distance from the left of the event to the initial
          ...
          _this.eventOffsetLeft =
            point.x - (0, _Selection.getBoundsForNode)(eventNode).left
          var isInBox = (0, _selection.pointInBox)(
